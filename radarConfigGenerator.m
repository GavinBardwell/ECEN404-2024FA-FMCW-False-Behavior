...
primary.range_res = 1;               % Range resolution in meters
...
emission_objects(1).position = [.1; 0; 0];  % Initial position in meters
emission_objects(1).velocity = [0; 0; 0];   % Initial velocity in m/s

benign_objects = [];
% Benign Objects
benign_objects(1).position = [20; 0; 0];    % Initial position in meters
benign_objects(1).velocity = [0; 0; 0];     % Initial velocity in m/s
benign_objects(1).rcs = 10;                 % Radar cross-section in dBsm
